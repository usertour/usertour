...
import { Alignment } from '@/pages/contents/components/builder/core/components/shared/alignment';
import { InputNumber } from '@/pages/contents/components/builder/core/components/shared/input';
