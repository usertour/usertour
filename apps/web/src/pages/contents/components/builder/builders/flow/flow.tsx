...
import { BuilderSideBar } from '@/pages/contents/components/builder/builders/flow/sidebar';
import { FlowBuilderDetail } from '@/pages/contents/components/builder/builders/flow/flow-detail';
import { FlowBuilderTrigger } from '@/pages/contents/components/builder/builders/flow/flow-trigger';
