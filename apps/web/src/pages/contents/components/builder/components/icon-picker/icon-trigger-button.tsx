  ...
  ({ iconSource, iconUrl, iconType, activeText, ...props }, ref) => {
    ...
    return (
      <Button
        ref={ref}
        variant="outline"
        className="flex h-7.5 w-full items-center justify-start rounded-lg bg-surface dark:bg-surface-raised/50 px-3 text-sm font-normal shadow-none hover:bg-muted"
        type="button"
        {...props}
      >
        {renderIcon()}
