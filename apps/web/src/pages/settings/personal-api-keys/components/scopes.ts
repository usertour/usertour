...
export const API_TOKEN_SCOPE_OPTIONS: readonly ApiTokenScopeOption[] = [
  ...
  { value: 'user:write', labelKey: 'settings.personalApiKeys.scopes.usersWrite' },
  { value: 'company:read', labelKey: 'settings.personalApiKeys.scopes.companies' },
  { value: 'company:write', labelKey: 'settings.personalApiKeys.scopes.companiesWrite' },
  { value: 'session:read', labelKey: 'settings.personalApiKeys.scopes.sessions' },
  { value: 'session:manage', labelKey: 'settings.personalApiKeys.scopes.sessionsManage' },
