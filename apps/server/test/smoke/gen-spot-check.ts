...
const A_SEED = {
  ...
  webhookId: '__A_WEBHOOK__',
  webhookForOwnerDelete: '__A_WEBHOOK_OWNER_DELETE__',
  webhookForAdminDelete: '__A_WEBHOOK_ADMIN_DELETE__',
  webhookMessageId: '__A_WEBHOOK_MESSAGE__',
  signingSecretId: '__A_SIGNING_SECRET__',
  signingSecretForOwnerRevoke: '__A_SIGNING_SECRET_OWNER_REVOKE__',
  signingSecretForAdminRevoke: '__A_SIGNING_SECRET_ADMIN_REVOKE__',
  ssoProviderId: '__A_SSO_PROVIDER__',
  ssoProviderForOwnerDelete: '__A_SSO_PROVIDER_OWNER_DELETE__',
  ssoProviderForAdminDelete: '__A_SSO_PROVIDER_ADMIN_DELETE__',
};
const B_SEED = {
  ...
  webhookId: '__B_WEBHOOK__',
  webhookForOwnerDelete: '__B_WEBHOOK_OWNER_DELETE__',
  webhookForAdminDelete: '__B_WEBHOOK_ADMIN_DELETE__',
  webhookMessageId: '__B_WEBHOOK_MESSAGE__',
  signingSecretId: '__B_SIGNING_SECRET__',
  signingSecretForOwnerRevoke: '__B_SIGNING_SECRET_OWNER_REVOKE__',
  signingSecretForAdminRevoke: '__B_SIGNING_SECRET_ADMIN_REVOKE__',
  ssoProviderId: '__B_SSO_PROVIDER__',
  ssoProviderForOwnerDelete: '__B_SSO_PROVIDER_OWNER_DELETE__',
  ssoProviderForAdminDelete: '__B_SSO_PROVIDER_ADMIN_DELETE__',
};
const SHELL_VARS: Record<string, string> = {
  ...
  __A_WEBHOOK__: 'SMOKE_WEBHOOK_ID',
  __A_WEBHOOK_OWNER_DELETE__: 'SMOKE_WEBHOOK_FOR_OWNER_DELETE_ID',
  __A_WEBHOOK_ADMIN_DELETE__: 'SMOKE_WEBHOOK_FOR_ADMIN_DELETE_ID',
  __A_WEBHOOK_MESSAGE__: 'SMOKE_WEBHOOK_MESSAGE_ID',
  __A_SIGNING_SECRET__: 'SMOKE_SIGNING_SECRET_ID',
  __A_SIGNING_SECRET_OWNER_REVOKE__: 'SMOKE_SIGNING_SECRET_FOR_OWNER_REVOKE_ID',
  __A_SIGNING_SECRET_ADMIN_REVOKE__: 'SMOKE_SIGNING_SECRET_FOR_ADMIN_REVOKE_ID',
  __A_SSO_PROVIDER__: 'SMOKE_SSO_PROVIDER_ID',
  __A_SSO_PROVIDER_OWNER_DELETE__: 'SMOKE_SSO_PROVIDER_FOR_OWNER_DELETE_ID',
  __A_SSO_PROVIDER_ADMIN_DELETE__: 'SMOKE_SSO_PROVIDER_FOR_ADMIN_DELETE_ID',
  ...
  __B_WEBHOOK__: 'SMOKE_B_WEBHOOK_ID',
  __B_WEBHOOK_OWNER_DELETE__: 'SMOKE_B_WEBHOOK_FOR_OWNER_DELETE_ID',
  __B_WEBHOOK_ADMIN_DELETE__: 'SMOKE_B_WEBHOOK_FOR_ADMIN_DELETE_ID',
  __B_WEBHOOK_MESSAGE__: 'SMOKE_B_WEBHOOK_MESSAGE_ID',
  __B_SIGNING_SECRET__: 'SMOKE_B_SIGNING_SECRET_ID',
  __B_SIGNING_SECRET_OWNER_REVOKE__: 'SMOKE_B_SIGNING_SECRET_FOR_OWNER_REVOKE_ID',
  __B_SIGNING_SECRET_ADMIN_REVOKE__: 'SMOKE_B_SIGNING_SECRET_FOR_ADMIN_REVOKE_ID',
  __B_SSO_PROVIDER__: 'SMOKE_B_SSO_PROVIDER_ID',
  __B_SSO_PROVIDER_OWNER_DELETE__: 'SMOKE_B_SSO_PROVIDER_FOR_OWNER_DELETE_ID',
  __B_SSO_PROVIDER_ADMIN_DELETE__: 'SMOKE_B_SSO_PROVIDER_FOR_ADMIN_DELETE_ID',
};
