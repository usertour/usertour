...
import { CreateCheckoutSessionRequest } from './dtos/create-checkout-session-request.input';
...
export class SubscriptionResolver {
  ...
  async getSubscriptionByProjectId(@Args('projectId') projectId: string): Promise<SubscriptionDTO> {
