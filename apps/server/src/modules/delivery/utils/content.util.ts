...
import { ConditionExtractionMode } from '../constants/condition-extraction-mode.constant';
...
import { ContentWithContentOnEnvironments } from '../types/content-with-content-on-environments.type';
