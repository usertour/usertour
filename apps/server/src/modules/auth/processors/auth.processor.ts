...
import type { SendMagicLinkEmailJobData } from '../types/send-magic-link-email-job-data.type';
import type { SendResetPasswordEmailJobData } from '../types/send-reset-password-email-job-data.type';
import {
