...
import type { IdentityTokenDiagnosis } from '../types/identity-token-diagnosis.type';
import type { IdentityTokenPayload } from '../types/identity-token-payload.type';
import type { SignatureSubject } from '../types/signature-subject.type';
import type { SignatureVerdict } from '../types/signature-verdict.type';
import type { VerificationStats } from '../types/verification-stats.type';
import { isAnonymousExternalUserId } from '../utils/anonymous-external-user-id.util';
