...
import type { SsoProviderChanges } from '../types/sso-provider-changes.type';
...
export class SsoService {
  ...
  async updateProvider(id: string, input: SsoProviderChanges): Promise<ProjectSSOIdentityProvider> {
  ...
  async updateSettings(
    projectId: string,
    input: ProjectSsoSettingsChanges,
