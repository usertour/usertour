...
const COVERED: Record<string, string> = {
  ...
  restore_segment: 'openapi/mcp-tool-contract.e2e-spec.ts',
  restore_theme: 'openapi/mcp-tool-contract.e2e-spec.ts',
  restore_attribute_definition: 'openapi/mcp-tool-contract.e2e-spec.ts',
  restore_event_definition: 'openapi/mcp-tool-contract.e2e-spec.ts',
