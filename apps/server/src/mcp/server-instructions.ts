...
- Translate content → list_localizations, then get_version_localization / update_version_localization per locale (read the guide's \`localization\` section). After editing source text, check get_content_version with expand: ["localizations"] for outdated / missing translations BEFORE publishing.
