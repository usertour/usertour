...
const rcTab = z
  .object({
    ...
    name: z
      .string()
      .describe(
        'Tab label. Plain text — NO `{{ }}` interpolation (braces would render literally).',
      ),
    icon: rcIcon.optional(),
    blocks: z
      .array(rcBlock)
...
export const representationResourceCenter = z
  .object({
    buttonText: z
      .string()
      .optional()
