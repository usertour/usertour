...
const InputGroup = (props: InputGroupProps) => {
  ...
  return (
    <div
      ...
      role="group"
      className={cn(
        'group/input-group border-input dark:bg-surface-raised/50 relative flex w-full items-center rounded-md border shadow-xs transition-[color,box-shadow] outline-none',
