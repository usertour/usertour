  ...
  return (
    <CardHeader className="flex-none p-4 space-y-2">
      <CardTitle className="flex flex-row space-x-1 text-base items-center">
        ...
        <span className="truncate">Announcements block</span>
      </CardTitle>
    </CardHeader>
  );
};

const BlockAnnouncementBody = () => {
  ...
  if (!currentBlock || currentBlock.type !== ResourceCenterBlockType.ANNOUNCEMENT) {
    return null;
  }
        ...
        <div className="flex-col space-y-3 p-4">
          ...
          <div className="flex items-start space-x-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-blue-800">
              Announcements are managed from the Announcements page. This block displays the
              announcement list in the resource center.
            </p>
          </div>
...
export const ResourceCenterBlockAnnouncement = () => {
  return (
    <SidebarContainer>
      <BlockAnnouncementHeader />
      <BlockAnnouncementBody />
      <BlockAnnouncementFooter />
    </SidebarContainer>
  );
};
