  ...
  return (
    <CardHeader className="flex-none p-4 space-y-2">
      <CardTitle className="flex flex-row space-x-1 text-base items-center">
        ...
        <span className="truncate">Checklist block</span>
      </CardTitle>
    </CardHeader>
  );
};

const BlockChecklistBody = () => {
        ...
        <div className="flex-col space-y-3 p-4">
          <div className="flex items-start space-x-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-blue-800">
              If the user has an active Checklist, it will automatically be embedded in the resource
              center here. You have to create and publish a Checklist separately.
            </p>
          </div>
...
export const ResourceCenterBlockChecklist = () => {
  return (
    <SidebarContainer>
      <BlockChecklistHeader />
      <BlockChecklistBody />
      <BlockChecklistFooter />
    </SidebarContainer>
  );
};

ResourceCenterBlockChecklist.displayName = 'ResourceCenterBlockChecklist';
