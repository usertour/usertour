...
export const BannerIcon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ ...props }, forwardedRef) => {
    return (
      ...
      >
        <path
          d="M3 0L13 0C14.6569 0 16 1.34315 16 3L16 5C16 6.65685 14.6569 8 13 8L1.6002 8L1.6002 12.2001C1.6002 13.3615 2.49811 14.3099 3.6402 14.3901L3.8002 14.4001L7.8002 14.4001C8.24225 14.4001 8.6002 14.7581 8.6002 15.2001C8.6002 15.6081 8.29494 15.9411 7.9002 15.9901L7.8002 16.0001L3.8002 16.0001C1.76714 16.0001 0.111681 14.4075 0.0102 12.4001L0.0002 12.2001L0.0002 8L0 8L0 3C0 1.34315 1.34315 0 3 0ZM12.6707 9.81162L12.7343 9.73384C13.0227 9.44548 13.4743 9.42609 13.7879 9.6702L13.8657 9.73384L15.7041 11.5723C15.9925 11.8607 16.0119 12.3123 15.7678 12.6259L15.7041 12.7037L13.8657 14.5421C13.5533 14.8545 13.0467 14.8545 12.7343 14.5421C12.446 14.2538 12.4269 13.8024 12.6707 13.4885L12.7343 13.4108L13.207 12.9381L13.2 12.9381L9.8 12.9381C9.35817 12.9381 9 12.58 9 12.1382L9 12.1381C9 11.6963 9.35817 11.3382 9.8 11.3382L13.2 11.3382L13.2074 11.3382L12.7343 10.8652C12.446 10.5768 12.4266 10.1252 12.6707 9.81162ZM14 12.1308L14 12.1381L14 12.1382L14 12.1451L14.0071 12.138L14 12.1308Z"
          fillRule="evenodd"
          fill="currentColor"
        />
      </svg>
