...
import { BuilderMode, useBuilderStore, useEnvironmentId, useProjectId } from '../../contexts';
  ...
  return (
    <CardHeader className="flex-none p-4 space-y-2">
      <CardTitle className="flex flex-row items-center space-x-1 text-base">
        ...
        <span className="truncate">Divider block</span>
      </CardTitle>
    </CardHeader>
  );
};
...
const BlockDividerBody = () => {
  ...
  if (!currentBlock || currentBlock.type !== 'divider') {
    return null;
  }
        ...
        <div className="flex-col space-y-3 p-4">
          <div className="flex items-start space-x-2 rounded-lg border border-blue-200 bg-blue-50 p-3">
            ...
            <p className="text-sm text-blue-800">
              Add a divider line to separate blocks in your resource center.
            </p>
          </div>
...
export const ResourceCenterBlockDivider = () => {
  return (
    <SidebarContainer>
      <BlockDividerHeader />
      <BlockDividerBody />
...
ResourceCenterBlockDivider.displayName = 'ResourceCenterBlockDivider';
