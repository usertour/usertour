const translations = {
  ...
  settings: {
    ...
    integrations: {
      ...
      headerBody: '将 Usertour 事件实时推送到你的分析工具。',
      notFound: '该集成不存在。',
      downgraded: {
        banner:
          '当前套餐不包含集成功能 — 事件推送已暂停。你仍可以查看和移除已有配置;升级套餐即可恢复推送。',
      },
      locked: {
        title: '集成为付费套餐功能',
        description:
      ...
      autoDisabled: {
        badge: '自动停用',
        tooltip: '因持续投递失败,Usertour 已于 {{time}} 停用该集成。',
        banner:
          '因持续一周投递失败,Usertour 已于 {{time}} 停用该集成。最常见的原因是密钥被吊销或更换 — 更新密钥后重新启用即可。',
      },
      cooldown: {
        badge: '冷却中',
        tooltip:
      ...
      form: {
        ...
        keyPlaceholders: {
          amplitude: '粘贴你的 Amplitude API key',
          heap: '粘贴你的 Heap App ID',
          mixpanel: '粘贴你的 Mixpanel project token',
