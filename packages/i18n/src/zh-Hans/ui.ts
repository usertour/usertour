const translations = {
  ...
  admin: {
    ...
    guard: {
      ...
      accessDeniedDescription: '你必须是系统管理员才能访问此页面。',
    },
    general: {
      title: '基本信息',
      description: '管理本次自托管部署的实例基本信息。',
      instanceIdDescription: '该实例的唯一只读标识符。',
      instanceIdCopied: '实例 ID 已复制到剪贴板',
      instanceName: '实例名称',
      instanceNameDescription: '用于标识此自托管实例的友好名称。',
      instanceNamePlaceholder: '请输入实例名称',
      contactEmail: '系统管理员联系邮箱',
      contactEmailDescription: '该实例的联系邮箱，无需归属于特定用户。',
      contactEmailPlaceholder: 'admin@example.com',
      allowProjectSubscription: '允许项目级订阅管理',
      allowProjectSubscriptionDescription:
        '启用后，自托管项目设置中将显示订阅页面。禁用则统一使用实例级订阅管理。现有项目许可证不受影响。',
      settingsUpdated: '基本设置已更新',
    },
    authentication: {
      title: '身份验证',
      description: '配置用户注册此自托管实例的方式。',
      allowRegistrationLabel: '允许新用户注册',
      allowRegistrationDescription:
        '禁用后，仅系统管理员可创建新用户，基于邀请的加入流程仍然可用。',
      settingsUpdated: '身份验证设置已更新',
    },
    subscription: {
      title: '订阅',
      description: '管理此自托管部署的实例许可证和订阅详情。',
      sectionDescription: '查看并管理您的订阅',
      currentPlanLabel: '当前套餐：',
      expiredOn: '已于 {{date}} 过期',
      expiresOn: '到期时间：{{date}}',
      totalProjects: '项目总数：{{count}}',
      projectLimit: '项目上限：{{limit}}',
      noLicense: '无许可证',
      unlimited: '不限',
      projectsUsingLicense: '使用实例许可证的项目数：{{count}}',
      daysRemaining: '剩余天数：{{days}}',
      scope: '范围：{{scope}}',
      overLimitWarning:
        '项目用量已超出当前实例许可证上限。已有分配仍然有效，但在用量降低之前，不能再将实例许可证分配给新项目。',
      unlimitedLicenseNote: '此实例许可证将自动应用于所有未单独配置项目许可证的项目。',
      instanceIdDescription: '唯一的只读实例 ID。',
      instanceIdCopied: '实例 ID {{instanceId}} 已复制到剪贴板',
      uploadLicense: '上传许可证',
      uploadLicenseDescription:
        '粘贴实例许可证，以解锁此自托管部署中所有项目的功能。保存后不会显示已有许可证内容。',
      licensePlaceholder: '敏感内容 - 仅写入',
      licenseCannotBeEmpty: '许可证不能为空',
      licenseUpdated: '许可证已更新',
      updating: '更新中…',
    },
    users: {
      clearFilter: '清除筛选',
      systemAdminRemoved: '已移除系统管理员',
      systemAdminGranted: '已授予系统管理员',
      userEnabled: '用户已启用',
      userDisabled: '用户已停用',
      removeSystemAdmin: '移除系统管理员',
      makeSystemAdmin: '设为系统管理员',
      enableUser: '启用用户',
      disableUser: '停用用户',
      validationNameRequired: '请输入姓名',
      validationEmailRequired: '请输入邮箱',
      validationPasswordMinLength: '密码至少需要 8 位字符',
      ...
      creating: '创建中…',
      pageTitle: '用户',
      pageDescription: '查看并管理此自托管实例中的所有用户，包括系统管理员权限。',
      ...
      roleNonAdmin: '普通用户',
      noUsersFound: '未找到用户。',
      totalUsers_one: '共 {{count}} 位用户',
      totalUsers_other: '共 {{count}} 位用户',
    },
    projects: {
      clearFilter: '清除筛选',
      licenseSourceProject: '项目',
      licenseSourceInstance: '实例',
      licenseSourceNone: '无',
      pleaseSelectUser: '请选择一个用户',
      memberAddedSuccess: '成员添加成功',
      addMemberTitle: '添加成员',
      userLabel: '用户',
      showingTop20: '显示前 20 条结果，请精细搜索以缩小范围。',
      searchUsersHintMember: '通过姓名或邮箱搜索用户以将其添加到此项目。',
      addingMember: '添加中…',
      addMemberButton: '添加成员',
      roleChangedSuccess: '角色修改成功',
      ownershipTransferredSuccess: '所有权转让成功',
      memberRemovedSuccess: '成员移除成功',
      changeRole: '更改角色',
      transferOwnershipAction: '将所有权转让给此用户',
      removeMember: '移除成员',
      changeRoleTitle: '更改团队成员角色',
      transferOwnershipTitle: '转让账号所有权',
      transferOwnershipConfirm:
        '每个 Usertour 账号只能有一位所有者。转让后无法撤销。确认将账号所有权转让给 {{memberName}}？',
      transferOwnershipButton: '确认转让所有权',
      confirmTitle: '确认',
      removeMemberConfirm: '确认移除成员 {{email}}？',
      removeMemberButton: '移除成员',
      membersDialogTitle: '{{projectName}} 的成员',
      memberCount_one: '{{count}} 名成员',
      memberCount_other: '{{count}} 名成员',
      noMembers: '暂无成员。',
      instanceLicenseDisabled: '已为项目停用实例许可证',
      instanceLicenseEnabled: '已为项目启用实例许可证',
      openProject: '打开',
      viewMembers: '查看成员',
      stopUsingInstanceLicense: '停用实例许可证',
      useInstanceLicense: '使用实例许可证',
      pleaseEnterProjectName: '请输入项目名称',
      pleaseSelectOwner: '请选择所有者',
      ...
      ownerLabel: '所有者',
      selectOwner: '选择所有者',
      searchUsersHintOwner: '通过姓名或邮箱搜索用户以选择所有者。',
      creatingProject: '创建中…',
      createButton: '创建',
      pageTitle: '项目',
      pageDescription: '查看并管理此自托管实例中的所有项目，包括所有者和成员。',
      findProject: '查找项目',
      assignmentFilter: '许可证分配',
      usingInstanceLicense: '使用实例许可证',
      notUsingInstanceLicense: '未使用实例许可证',
      createProject: '创建项目',
      overProjectLimitWarning:
        '项目用量已超出当前实例许可证限制。现有分配仍可正常使用，但在减少用量之前无法新增。',
      ownerColumn: '所有者',
      licenseColumn: '许可证',
  ...
  settings: {
    ...
    sso: {
      ...
      locked: {
        cloud: {
          ...
          description: 'Business 套餐可让团队通过你自己的身份提供商登录。',
          upgrade: '升级到 Business',
        },
        selfHosted: {
          title: '单点登录需要 License',
          description: '在本实例激活 License 即可启用单点登录。',
        },
      },
      form: {
        ...
        issuerHelp: '提供商的 issuer；端点会从其 /.well-known/openid-configuration 自动发现。',
        clientIdLabel: 'Client ID',
        clientSecretLabel: 'Client Secret',
        clientSecretKeep: '留空则保留当前密钥',
        clientSecretRequired: '请填写 Client Secret',
        defaultRoleLabel: '新用户默认角色',
        defaultRoleHelp: '用户首次通过 SSO 登录时分配的角色。',
        allowedDomainsLabel: '允许的邮箱域名（可选）',
    ...
    api: {
      ...
      deprecation: '环境 API 密钥即将下线、后续版本将移除,请改用 <a>Personal API keys</a>。',
      newButton: '新建 API 密钥',
      columns: {
        name: '名称',
        key: '密钥',
    ...
    personalApiKeys: {
      title: '个人 API 密钥',
      description: '个人 API 密钥代表您本人对 REST API 发起请求,并限定在您所选的项目与权限范围内。',
      descriptionOnce: '<strong>完整密钥仅在创建后显示一次</strong>,之后无法再次查看。',
      headerDocs: '阅读 API 文档',
      newButton: '新建密钥',
      empty: '暂无个人 API 密钥。',
      form: {
      ...
      presets: {
        placeholder: '选择预设',
        aiAgent: 'AI 代理(完整创作)',
        contentAuthoring: '内容创作',
        userDataSync: '用户数据同步',
        readOnly: '只读访问',
        allAccess: '全部权限',
      },
      revealTitle: '请立即保存您的 API 密钥',
      revealDescription: '该密钥仅显示一次,之后无法再次获取。请在关闭此对话框前复制并妥善保存。',
      copied: '密钥已复制到剪贴板',
      copyFailed: '复制密钥失败,请手动复制。',
      editMenuItem: '编辑',
      editTitle: '编辑个人 API 密钥',
      saveButton: '保存修改',
      saving: '保存中…',
      updateSuccess: '个人 API 密钥已更新',
      updateFailure: '更新个人 API 密钥失败。',
      rotateMenuItem: '轮换密钥',
      rotateConfirmTitle: '轮换此密钥?',
    ...
    identityVerification: {
      title: '{{environment}} 环境的身份验证',
      headerBody:
        '证明 identify() 和 group() 调用真的来自您的应用。您的后端用签名密钥为每个用户签发 JWT,Usertour 可以拒绝没有有效令牌的身份。',
      headerDocs: '阅读身份验证指南',
      secrets: {
        sectionTitle: '签名密钥',
        generateButton: '生成密钥',
        rotateButton: '轮换密钥',
        rotateConfirmTitle: '轮换签名密钥?',
        rotateConfirmDescription:
          '将生成一个新密钥作为当前密钥。旧密钥在您吊销之前仍然有效 —— 把后端切换到新密钥,等旧密钥的「最后使用」时间停止更新后再吊销它。',
        rotateConfirmAction: '轮换密钥',
        finishRotationTooltip: '轮换正在进行中。请先吊销旧密钥,再进行下一次轮换。',
        currentLabel: '当前密钥',
        previousLabel: '旧密钥',
        rotatingOutBadge: '轮换中',
        rotatingOutHint:
          '用此密钥签发的令牌仍被接受。确认后端已不再使用它(查看「最后使用」)后,请吊销。',
        createdAt: '创建于',
        lastUsedAt: '最后使用',
        neverUsed: '从未使用',
        empty: '暂无签名密钥。生成一个,开始签发身份令牌。',
        copyButton: '复制密钥',
        revealButton: '查看密钥',
        revokeButton: '吊销密钥',
        revokeConfirmTitle: '吊销签名密钥?',
        revokeConfirmDescription:
          '用此密钥签发的令牌将立即失效。请先确认您的后端已不再使用它 —— 检查它的「最后使用」时间。',
        revokeConfirmAction: '吊销密钥',
        revokeSuccess: '签名密钥已吊销',
        revokeFailure: '吊销签名密钥失败',
        createFailure: '生成签名密钥失败',
        dialogTitle: '签名密钥',
        dialogCreatedTitle: '新签名密钥',
        dialogDescription:
      ...
      enforcement: {
        ...
        enableConfirmDescription:
          '没有有效身份令牌的用户将被拒绝,Usertour 不会为他们加载。请先确认已签名流量达到 100% 再开启。',
        enableConfirmAction: '强制验证',
        enabledToast: '已开启强制身份验证',
        disabledToast: '已关闭强制身份验证',
      },
      validator: {
        title: '校验令牌',
      ...
      coverage: {
        title: '已签名流量',
        description: '最近 7 天带有效身份令牌的身份声明占比。达到 100% 后再开启强制验证。',
        users: '用户',
        companies: '公司',
        noTraffic: '暂无流量',
        breakdown: '{{valid}} 有效 · {{invalid}} 无效 · {{missing}} 未签名',
        anonymousNote: '{{count}} 个匿名用户(无需签名)',
      },
    },
    webhooks: {
      title: '{{environment}} 环境的 Webhook',
      headerBody:
        'Webhook 会在事件发生时将其 POST 到您的接收端,并使用每个端点独立的密钥签名,便于校验来源。',
      newButton: '新建 Webhook',
      empty: '还没有 Webhook。创建一个以开始接收事件。',
      columns: {
        url: '接收端 URL',
        topics: '订阅主题',
        status: '状态',
      ...
      picker: {
        selectAll: '全选',
        selectAllHint: '包含当前和未来新增的全部事件 — 但不含页面浏览这类高频事件,需要单独勾选。',
        search: '按名称查找事件…',
        noMatches: '没有匹配的事件。',
        selectedCount: '已选 {{count}} / {{total}}',
        eventsCount_one: '{{count}} 个事件',
        eventsCount_other: '{{count}} 个事件',
        highVolume: '高频',
        highVolumeHint: '「全选」和所属分组都不包含它 — 确实需要每次页面浏览时请单独勾选。',
        autoIncludeHint: '勾选整个分组时,之后新增到该分组的事件也会自动包含。',
        families: {
          tracked: '行为事件',
          content: '内容',
          users: '用户',
      ...
      secret: {
        label: '签名密钥',
        hint: '每次投递都会用 HMAC-SHA256 签名并放在 X-Usertour-Signature 请求头中,请在服务端校验。',
        revealButton: '显示密钥',
        copyButton: '复制密钥',
        copied: '密钥已复制到剪贴板',
        rotateButton: '轮换密钥',
        rotateSuccess: '签名密钥已轮换',
        rotateFailure: '轮换签名密钥失败',
  ...
  contents: {
    ...
    environments: {
      title: '环境',
      tooltip: '此内容当前在各环境的发布状态——每个环境显示在线版本。',
      since: '{{date}} 上线',
      notPublished: '未发布',
      draftAhead: '草稿 v{{version}} 领先',
    },
    publishHistory: {
      title: '发布历史',
      tooltip: '该内容的每次发布与下线记录——哪个版本发到了哪个环境、何时、由谁操作。',
      countLabel: '{{count}} 条记录',
      empty: '尚未发布。',
      endOfHistory: '已显示全部',
      unpublished: '下线自',
      filterAll: '全部环境',
      emptyFiltered: '该环境暂无发布记录。',
      by: '由 {{name}}',
      viaToken: '通过 {{token}}',
      viaApi: '通过 API',
    },
  ...
  contentBuilder: {
    ...
    editor: {
      ...
      question: {
        ...
        whenSubmitted: '提交答案时',
        labels: '标签',
        labelsTooltip: '在每个选项下方加个标签，把含义说清楚，比如左边标"差"、右边标"好"。',
        defaultLabel: '默认',
        scaleRange: '取值范围',
      ...
      embed: {
        url: '嵌入 URL',
        urlTooltip:
          '把你想嵌入的内容 URL 粘进来——YouTube 视频、表单、文档、网站，甚至视频文件的直链都行。网上大多数可嵌入的内容都支持。',
      ...
      multipleChoice: {
        namePlaceholder: '输入问题名称',
        optionValue: '值',
        optionLabel: '选项标签',
        removeOption: '删除选项',
        options: '选项',
        addOption: '添加选项',
        numberRequired: '需要选择的数量',
        submitButton: '提交按钮文字',
        submitButtonPlaceholder: '输入按钮文字',
        shuffle: '随机排列选项顺序',
        enableOther: '启用"其他"选项',
        otherPlaceholder: '"其他"选项占位文字',
    ...
    shared: {
      width: '宽度',
      widthTooltip: {
        modal: '模态框的宽度，单位像素。留空就用主题默认值。',
        tooltip: '提示框的宽度，单位像素。留空就用主题默认值。',
        checklist: '清单的宽度，单位像素。留空就用主题默认值。',
        bubble: '气泡的宽度，单位像素。留空就用主题默认值。',
      },
      widthPlaceholder: '默认：{{value}}',
      widthCannotBeZero: '宽度不能为 0',
      alignment: '对齐方式',
      alignmentTooltip:
        '选择提示框出现在目标元素的哪一侧。默认情况下，它会根据目标的位置和用户屏幕的大小，自动放到最合适的一侧。',
      auto: '自动',
      fixed: '固定',
      ...
      placement: '位置',
      placementTooltip: '{{name}}放在哪个角落。',
      horizontalOffset: '水平偏移',
      horizontalOffsetTooltip: '{{name}}离浏览器窗口水平边缘留多少像素。',
      verticalOffset: '垂直偏移',
      verticalOffsetTooltip: '{{name}}离浏览器窗口垂直边缘留多少像素。',
      position: {
        leftTop: '左上',
        centerTop: '上中',
        rightTop: '右上',
      ...
      elementText: '元素文本',
      elementTextTooltip: '我们会选中包含你在这里输入的文本的元素。',
      cssSelector: 'CSS 选择器',
      cssSelectorTooltip:
        '能用文本定位元素时，优先用文本。要是元素没有文本，或者文本太通用，就改用 CSS 选择器。文本和 CSS 选择器都填了的话，我们会选中同时匹配这两者的元素。',
      ...
      ifMultipleMatchesTooltip:
        '要是有多个元素都符合条件，你可以指定选中哪一个。元素先从上到下排，再从左到右排——所以越靠上、越靠左的越优先。',
      ...
      theme: {
        ...
        edit: '编辑该主题',
        stepTooltip:
          '这一步要是有特殊需求，可以单独给它换一个主题，不用跟流程其余部分一样。主题在「设置 - 主题」里设计。',
        flowTooltip: '这个流程每个步骤默认用的主题',
        sameAsFlow: '与流程主题一致',
    ...
    flow: {
      ...
      triggerTooltipDescription: '条件一满足就自动执行动作——比如跳转步骤、启动其他流程或关闭。',
      ...
      addBackdropTooltipHint:
        '在你的应用上面盖一层半透明遮罩，只露出提示框和目标元素。想逼用户去操作目标元素时用它。',
    ...
    banner: {
      ...
      embedPlacementTooltip:
        '选横幅显示在哪：页面顶部或底部，或者相对某个元素（内部、之前或之后）。',
      ...
      maxEmbedWidthTooltip: '嵌入容器最宽能到多少像素。留空就不限制。',
      maxContentWidth: '最大内容宽度',
      maxContentWidthTooltip: '横幅内容最宽能到多少像素。留空就不限制。',
      borderRadius: '圆角',
      borderRadiusTooltip: '圆角的大小，单位像素。留空就用默认值。',
      outerMargin: '外边距',
      outerMarginTooltip: '横幅四周留的空白（上、右、下、左），单位像素。',
      none: '无',
      marginTop: '上',
      marginBottom: '下',
      marginLeft: '左',
      ...
      settingsItems: {
        overlay: '覆盖在内容之上',
        overlayTooltip: '横幅是浮在页面内容上面，还是占一块地方把内容往下挤。',
        stickToTop: '固定在顶部',
        stickToTopTooltip: '滚动时把横幅钉在顶部，不让它跟着页面滚走。',
        allowDismiss: '允许关闭',
        allowDismissTooltip: '加个 X 按钮，让用户能彻底关掉横幅。',
        animate: '出现时动画',
        animateTooltip: '让横幅带动画滑进来，而不是一下子蹦出来。',
      },
      targetElement: '目标元素',
    },
    checklist: {
      ...
      initialDisplayTooltip: '清单启动时，是展示整个清单（连任务一起），还是只显示启动器按钮。',
      ...
      preventDismissalTooltip: '不让用户关掉清单。',
      autoDismiss: '自动关闭清单',
      autoDismissTooltip: '所有任务都完成后，自动关掉清单。',
      item: '清单任务',
      itemName: '名称',
    ...
    resourceCenter: {
      ...
      tabs: '标签页',
      tabsTooltip:
        '要是一个标签页只有一个可导航区块（比如子页面或流程/清单列表），会直接打开它的详情视图，不用再点一下。',
      addTab: '添加标签页',
      untitledTab: '未命名标签页',
      tabSettings: '标签页设置',
      name: '名称',
      ...
      defaultFlowIconTooltip: '流程项默认用的图标，单个项也可以单独换。',
      defaultChecklistIcon: '清单默认图标',
      defaultChecklistIconTooltip: '清单项默认用的图标，单个项也可以单独换。',
      contentLabel: '内容',
      contentTooltip: '这里只能添加流程和清单。点某一项就能编辑它的设置。',
      remove: '移除',
      add: '添加',
      ...
      navigateUrlTooltip: '用户点这一项时，把他跳转到这个 URL。这里可以用用户属性。',
