const translations = {
  ...
  twoFactor: {
    ...
    description:
      "Add an extra layer of security to your account. When signing in, you'll be required to enter a verification code generated by an authenticator app such as Google Authenticator, 1Password, or Authy.",
    recoveryCodes: {
    ...
    setup: {
      ...
      step3Description:
        "If you lose access to your authenticator, you can use one of these one-time codes to sign in. Save them somewhere safe — they won't be shown again.",
    ...
    disable: {
      ...
      description: 'After disabling, you will sign in with just your password.',
    ...
    errors: {
      ...
      challengeExpired: 'Verification session has expired. Please sign in again.',
    },
    adminEnforce: {
