const translations = {
  ...
  settings: {
    ...
    team: {
      ...
      roleDescriptions: {
        admin: 'Admins can create and edit everything and publish to every environment.',
        editor:
    ...
    webhooks: {
      ...
      headerBody:
        'Webhooks POST Usertour events to your endpoint as they happen — signed with a per-endpoint secret so you can verify authenticity.',
      newButton: 'New webhook',
      empty: 'No webhooks yet. Create one to start receiving events.',
      columns: {
        url: 'Endpoint URL',
        topics: 'Topics',
        status: 'Status',
      ...
      allEventsSummary: 'All events',
      allTrackedEventsSummary: 'All tracked events',
      allTrackedEventsPlus: 'All tracked events +{{count}}',
      ...
      deleteFailure: 'Failed to delete webhook',
      ...
      picker: {
        ...
        selectAllHint:
          'Every current and future event — except high-volume ones like Page Viewed, which must be enabled on their own.',
        ...
        highVolumeHint:
          'Not included by "Select all" or by its group — enable it explicitly if you really want every page view.',
        autoIncludeHint: 'Selecting the whole group also includes events added to it later.',
        families: {
      ...
      secret: {
        ...
        hint: 'Each delivery is signed with HMAC-SHA256 in the X-Usertour-Signature header. Verify it on your server.',
        revealButton: 'Reveal secret',
        copyButton: 'Copy secret',
        copied: 'Secret copied to clipboard',
        rotateButton: 'Rotate secret',
        rotateSuccess: 'Signing secret rotated',
        rotateFailure: 'Failed to rotate signing secret',
        rotateConfirmTitle: 'Rotate signing secret?',
        rotateConfirmDescription:
